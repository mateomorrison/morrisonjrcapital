...
export const metadata: Metadata = {
  metadataBase: new URL('https://morrisonjrgroup.com'),
  title: "MORRISON JR GROUP | Founded by Mateo Morrison Jr",
  ...
  alternates: {
    canonical: "https://morrisonjrgroup.com",
  },
};
